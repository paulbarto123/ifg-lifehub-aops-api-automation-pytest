...
BASE_URL_CORE_DEV = "https://api-core-dev.ifg-life.id"
API_KEY_CORE_DEV = "AXBJVtacQkg9vOVjurl1qJXPwHIC9Nh3"
BASE_URL_IFGID_DEV = "https://api-ifgid-dev.ifg-life.id"
API_KEY_IFGID_DEV = "cKTZHYVVJab2Kxk69wqVsSLmlCHIbkHp"
BASE_URL_AOPS_DEV = "https://api-automation-v2-dev.ifg-life.id"
API_KEY_AOPS_DEV = "YfPCr603s4OyM4pMUAuHvaWIl1kmmkWq"

def test_search_organization_policy_success():

############## Step 1: Search for organization policy
    url_policy_search = f"{BASE_URL_CORE_DEV}/v2/pas/organization-policies/search"
    headers = {
        "apiKey": API_KEY_CORE_DEV,
...
#     url_get_policy_member = f"{BASE_URL_CORE_DEV}/v2/pas/policy/search"
#     headers = {
#         "apiKey": API_KEY_CORE_DEV,
#         "Content-Type": "application/json"
#     }
...
#     url_check_policy_number = f"{BASE_URL_CORE_DEV}/v2/pas/policies/search"
#     headers = {
#         "apiKey": API_KEY_CORE_DEV,
#         "Content-Type": "application/json"
#     }
...
#     url_get_data_member = f"{BASE_URL_IFGID_DEV}/api/v6/ekyc/data/getEkycInfo"
#     headers = {
#         "apiKey": API_KEY_IFGID_DEV,
#         "Content-Type": "application/json"
#     }
...
#         f"{BASE_URL_AOPS_DEV}/api/v2/ao-workflow-claim/general/transaction/header"
#     )

#     headers = {
#         "apiKey": API_KEY_AOPS_DEV,
#         "Content-Type": "application/json"
#     }
...
#     url_get_data_member = f"{BASE_URL_AOPS_DEV}/api/v6/ekyc/data/getEkycInfo"
#     headers = {
#         "apiKey": API_KEY_AOPS_DEV,
#         "Content-Type": "application/json"
#     }
